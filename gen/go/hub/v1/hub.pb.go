...
// IdentifierIdentityLevel describes what an identifier identifies. Matching
// policy can then decide whether equality proves identity at the desired
// repository granularity.
type IdentifierIdentityLevel int32

const (
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_UNSPECIFIED   IdentifierIdentityLevel = 0
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_WORK          IdentifierIdentityLevel = 1
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_VERSION       IdentifierIdentityLevel = 2
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_MANIFESTATION IdentifierIdentityLevel = 3
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_CONCEPT       IdentifierIdentityLevel = 4
	IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_SOURCE_RECORD IdentifierIdentityLevel = 5
)

// Enum value maps for IdentifierIdentityLevel.
var (
	IdentifierIdentityLevel_name = map[int32]string{
		0: "IDENTIFIER_IDENTITY_LEVEL_UNSPECIFIED",
		1: "IDENTIFIER_IDENTITY_LEVEL_WORK",
		2: "IDENTIFIER_IDENTITY_LEVEL_VERSION",
		3: "IDENTIFIER_IDENTITY_LEVEL_MANIFESTATION",
		4: "IDENTIFIER_IDENTITY_LEVEL_CONCEPT",
		5: "IDENTIFIER_IDENTITY_LEVEL_SOURCE_RECORD",
	}
	IdentifierIdentityLevel_value = map[string]int32{
		"IDENTIFIER_IDENTITY_LEVEL_UNSPECIFIED":   0,
		"IDENTIFIER_IDENTITY_LEVEL_WORK":          1,
		"IDENTIFIER_IDENTITY_LEVEL_VERSION":       2,
		"IDENTIFIER_IDENTITY_LEVEL_MANIFESTATION": 3,
		"IDENTIFIER_IDENTITY_LEVEL_CONCEPT":       4,
		"IDENTIFIER_IDENTITY_LEVEL_SOURCE_RECORD": 5,
	}
)

func (x IdentifierIdentityLevel) Enum() *IdentifierIdentityLevel {
	p := new(IdentifierIdentityLevel)
	*p = x
	return p
}

func (x IdentifierIdentityLevel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IdentifierIdentityLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_hub_v1_hub_proto_enumTypes[5].Descriptor()
}

func (IdentifierIdentityLevel) Type() protoreflect.EnumType {
	return &file_hub_v1_hub_proto_enumTypes[5]
}

func (x IdentifierIdentityLevel) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IdentifierIdentityLevel.Descriptor instead.
func (IdentifierIdentityLevel) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	IdentifierType_IDENTIFIER_TYPE_WOS           IdentifierType = 17 // Web of Science accession number (UT)
)
...
func (RelationType) Descriptor() protoreflect.EnumDescriptor {
	return file_hub_v1_hub_proto_enumTypes[10].Descriptor()
}

func (RelationType) Type() protoreflect.EnumType {
	return &file_hub_v1_hub_proto_enumTypes[10]
}
...
type SourceInfo struct {
	...
	// Origin identifies the source system or installation that supplied the
	// record, independent of the serialization format.
	Origin string `protobuf:"bytes,7,opt,name=origin,proto3" json:"origin,omitempty"`
	// Source URI is the canonical API or public locator for the source record.
	SourceUri string `protobuf:"bytes,8,opt,name=source_uri,json=sourceUri,proto3" json:"source_uri,omitempty"`
	// Profile fingerprint identifies the exact immutable mapping contract used
	// to parse this record. It is populated together with model_fingerprint.
	ProfileFingerprint string `protobuf:"bytes,9,opt,name=profile_fingerprint,json=profileFingerprint,proto3" json:"profile_fingerprint,omitempty"`
	// Model fingerprint identifies the exact source-system schema snapshot to
	// which the profile was bound.
	ModelFingerprint string `protobuf:"bytes,10,opt,name=model_fingerprint,json=modelFingerprint,proto3" json:"model_fingerprint,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SourceInfo) GetSourceUri() string {
	if x != nil {
		return x.SourceUri
	}
	return ""
...
func (x *SourceInfo) GetProfileFingerprint() string {
	if x != nil {
...
func (x *SourceInfo) GetModelFingerprint() string {
	if x != nil {
...
type Identifier struct {
	...
	// Scheme is the open, canonical machine name for the identifier namespace
	// (for example doi, scopus-eid, or an institution-defined local scheme).
	// IdentifierType remains a broad interoperability hint; Scheme is the
	// authoritative discriminator for schemes that are not represented by the
	// closed enum.
	Scheme string `protobuf:"bytes,5,opt,name=scheme,proto3" json:"scheme,omitempty"`
	// Namespace URI scopes the value to its issuing authority or repository.
	// Repository-local values must have a namespace before reconciliation can
	// treat them as exact identity evidence.
	NamespaceUri string `protobuf:"bytes,6,opt,name=namespace_uri,json=namespaceUri,proto3" json:"namespace_uri,omitempty"`
	// Identity level distinguishes identifiers for a work, one version or
	// manifestation, a concept spanning versions, or a source-system record.
	IdentityLevel IdentifierIdentityLevel `protobuf:"varint,7,opt,name=identity_level,json=identityLevel,proto3,enum=hub.v1.IdentifierIdentityLevel" json:"identity_level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Identifier) GetScheme() string {
	if x != nil {
		return x.Scheme
	}
	return ""
...
func (x *Identifier) GetNamespaceUri() string {
	if x != nil {
...
func (x *Identifier) GetIdentityLevel() IdentifierIdentityLevel {
	if x != nil {
		return x.IdentityLevel
	}
	return IdentifierIdentityLevel_IDENTIFIER_IDENTITY_LEVEL_UNSPECIFIED
}
...
type File struct {
	...
	Uri               string                 `protobuf:"bytes,7,opt,name=uri,proto3" json:"uri,omitempty"`   // Canonical remote resource URI, when no local path exists.
	...
	AccessUrl         string                 `protobuf:"bytes,10,opt,name=access_url,json=accessUrl,proto3" json:"access_url,omitempty"` // Download URL when distinct from the resource URI.
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *File) GetAccessUrl() string {
	if x != nil {
		return x.AccessUrl
	}
	return ""
...
const file_hub_v1_hub_proto_rawDesc = "" +
	...
	"\x0funmapped_fields\x18\x06 \x03(\tR\x0eunmappedFields\x12\x16\n" +
	"\x06origin\x18\a \x01(\tR\x06origin\x12\x1d\n" +
	"\n" +
	"source_uri\x18\b \x01(\tR\tsourceUri\x12/\n" +
	"\x13profile_fingerprint\x18\t \x01(\tR\x12profileFingerprint\x12+\n" +
	"\x11model_fingerprint\x18\n" +
	" \x01(\tR\x10modelFingerprint\"\x86\x01\n" +
	"\x05Group\x12%\n" +
	...
	"\x06season\x18\r \x01(\tR\x06season\"\x90\x02\n" +
	"\n" +
	"Identifier\x12*\n" +
	...
	"\fis_preferred\x18\x04 \x01(\bR\visPreferred\x12\x16\n" +
	"\x06scheme\x18\x05 \x01(\tR\x06scheme\x12#\n" +
	"\rnamespace_uri\x18\x06 \x01(\tR\fnamespaceUri\x12F\n" +
	"\x0eidentity_level\x18\a \x01(\x0e2\x1f.hub.v1.IdentifierIdentityLevelR\ridentityLevel\"\xb2\x01\n" +
	"\aSubject\x12\x14\n" +
	...
	"identifier\x18\x02 \x01(\tR\n" +
	"identifier\x12'\n" +
	"\x0fidentifier_type\x18\x03 \x01(\tR\x0eidentifierType\"\x9c\x02\n" +
	"\x04File\x12\x12\n" +
	...
	"\x03uri\x18\a \x01(\tR\x03uri\x12\x1a\n" +
	"\bchecksum\x18\b \x01(\tR\bchecksum\x12-\n" +
	"\x12checksum_algorithm\x18\t \x01(\tR\x11checksumAlgorithm\x12\x1d\n" +
	"\n" +
	"access_url\x18\n" +
	" \x01(\tR\taccessUrl\"t\n" +
	...
	"\x13DATE_QUALIFIER_BOTH\x10\x03*\x90\x02\n" +
	"\x17IdentifierIdentityLevel\x12)\n" +
	"%IDENTIFIER_IDENTITY_LEVEL_UNSPECIFIED\x10\x00\x12\"\n" +
	"\x1eIDENTIFIER_IDENTITY_LEVEL_WORK\x10\x01\x12%\n" +
	"!IDENTIFIER_IDENTITY_LEVEL_VERSION\x10\x02\x12+\n" +
	"'IDENTIFIER_IDENTITY_LEVEL_MANIFESTATION\x10\x03\x12%\n" +
	"!IDENTIFIER_IDENTITY_LEVEL_CONCEPT\x10\x04\x12+\n" +
	"'IDENTIFIER_IDENTITY_LEVEL_SOURCE_RECORD\x10\x05*\xfc\x03\n" +
	...
	"\x1bIDENTIFIER_TYPE_CALL_NUMBER\x10\x10\x12\x17\n" +
	"\x13IDENTIFIER_TYPE_WOS\x10\x11*\xc2\x01\n" +
...
var file_hub_v1_hub_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
...
var file_hub_v1_hub_proto_goTypes = []any{
	...
	(IdentifierIdentityLevel)(0),   // 5: hub.v1.IdentifierIdentityLevel
	(IdentifierType)(0),            // 6: hub.v1.IdentifierType
	(SubjectType)(0),               // 7: hub.v1.SubjectType
	(SubjectVocabulary)(0),         // 8: hub.v1.SubjectVocabulary
	(ResourceTypeValue)(0),         // 9: hub.v1.ResourceTypeValue
	(RelationType)(0),              // 10: hub.v1.RelationType
	(*Record)(nil),                 // 11: hub.v1.Record
	(*SourceInfo)(nil),             // 12: hub.v1.SourceInfo
	(*Group)(nil),                  // 13: hub.v1.Group
	(*Contributor)(nil),            // 14: hub.v1.Contributor
	(*ParsedName)(nil),             // 15: hub.v1.ParsedName
	(*DateValue)(nil),              // 16: hub.v1.DateValue
	(*Identifier)(nil),             // 17: hub.v1.Identifier
	(*Subject)(nil),                // 18: hub.v1.Subject
	(*Rights)(nil),                 // 19: hub.v1.Rights
	(*ResourceType)(nil),           // 20: hub.v1.ResourceType
	(*Relation)(nil),               // 21: hub.v1.Relation
	(*DegreeInfo)(nil),             // 22: hub.v1.DegreeInfo
	(*Funder)(nil),                 // 23: hub.v1.Funder
	(*Affiliation)(nil),            // 24: hub.v1.Affiliation
	(*File)(nil),                   // 25: hub.v1.File
	(*ArchivalLocation)(nil),       // 26: hub.v1.ArchivalLocation
	(*PublicationDetails)(nil),     // 27: hub.v1.PublicationDetails
	(*HierarchicalGeographic)(nil), // 28: hub.v1.HierarchicalGeographic
	(*structpb.Struct)(nil),        // 29: google.protobuf.Struct
	(*timestamppb.Timestamp)(nil),  // 30: google.protobuf.Timestamp
}
var file_hub_v1_hub_proto_depIdxs = []int32{
	14, // 0: hub.v1.Record.contributors:type_name -> hub.v1.Contributor
	16, // 1: hub.v1.Record.dates:type_name -> hub.v1.DateValue
	20, // 2: hub.v1.Record.resource_type:type_name -> hub.v1.ResourceType
	18, // 3: hub.v1.Record.genres:type_name -> hub.v1.Subject
	18, // 4: hub.v1.Record.subjects:type_name -> hub.v1.Subject
	27, // 5: hub.v1.Record.publication:type_name -> hub.v1.PublicationDetails
	19, // 6: hub.v1.Record.rights:type_name -> hub.v1.Rights
	17, // 7: hub.v1.Record.identifiers:type_name -> hub.v1.Identifier
	26, // 8: hub.v1.Record.archival_location:type_name -> hub.v1.ArchivalLocation
	25, // 9: hub.v1.Record.files:type_name -> hub.v1.File
	18, // 10: hub.v1.Record.physical_form:type_name -> hub.v1.Subject
	21, // 11: hub.v1.Record.relations:type_name -> hub.v1.Relation
	22, // 12: hub.v1.Record.degree_info:type_name -> hub.v1.DegreeInfo
	23, // 13: hub.v1.Record.funders:type_name -> hub.v1.Funder
	28, // 14: hub.v1.Record.geographic:type_name -> hub.v1.HierarchicalGeographic
	29, // 15: hub.v1.Record.extra:type_name -> google.protobuf.Struct
	12, // 16: hub.v1.Record.source_info:type_name -> hub.v1.SourceInfo
	30, // 17: hub.v1.SourceInfo.parsed_at:type_name -> google.protobuf.Timestamp
	0,  // 18: hub.v1.Group.type:type_name -> hub.v1.GroupType
	11, // 19: hub.v1.Group.container:type_name -> hub.v1.Record
	11, // 20: hub.v1.Group.members:type_name -> hub.v1.Record
	15, // 21: hub.v1.Contributor.parsed_name:type_name -> hub.v1.ParsedName
	1,  // 22: hub.v1.Contributor.type:type_name -> hub.v1.ContributorType
	17, // 23: hub.v1.Contributor.identifiers:type_name -> hub.v1.Identifier
	24, // 24: hub.v1.Contributor.affiliations:type_name -> hub.v1.Affiliation
	...
	30, // 28: hub.v1.DateValue.time:type_name -> google.protobuf.Timestamp
	6,  // 29: hub.v1.Identifier.type:type_name -> hub.v1.IdentifierType
	5,  // 30: hub.v1.Identifier.identity_level:type_name -> hub.v1.IdentifierIdentityLevel
	8,  // 31: hub.v1.Subject.vocabulary:type_name -> hub.v1.SubjectVocabulary
	7,  // 32: hub.v1.Subject.type:type_name -> hub.v1.SubjectType
	9,  // 33: hub.v1.ResourceType.type:type_name -> hub.v1.ResourceTypeValue
	10, // 34: hub.v1.Relation.type:type_name -> hub.v1.RelationType
	6,  // 35: hub.v1.Relation.target_id_type:type_name -> hub.v1.IdentifierType
	9,  // 36: hub.v1.Relation.target_resource_type:type_name -> hub.v1.ResourceTypeValue
	16, // 37: hub.v1.DegreeInfo.date:type_name -> hub.v1.DateValue
